...
class GildedRoseSpec extends Specification {
    ...
    def "check rule"() {
        ...
        SULFURAS         | -1     | 80      | -1                        | 80                         | "Sulfuras has a Quality of 80 that never alters"
        ...
        CONJURED         | 2      | 4       | 1                         | 2                          | CONJURED_ITEMS_DEGRADE_TWICE_AS_FAST
        CONJURED         | 1      | 1       | 0                         | 0                          | QUALITY_OF_AN_ITEM_IS_NEVER_NEGATIVE
        CONJURED         | 0      | 5       | -1                        | 1                          | CONJURED_ITEMS_DEGRADE_TWICE_AS_FAST + " and " + QUALITY_DEGRADES_TWICE_AS_FAST_AFTER_SELL_BY_DATE
        CONJURED         | 2      | 0       | 1                         | 0                          | QUALITY_OF_AN_ITEM_IS_NEVER_NEGATIVE
    }
